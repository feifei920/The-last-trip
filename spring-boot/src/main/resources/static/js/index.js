$(function () {
    ...
    function echart_1() {
        ...
        var xAxisData = ['通讯社交','影音播放','摄影图像','系统工具','网上购物','金融理财','考试学习','办公商务','生活休闲','新闻阅读','旅游出行','手机美化','健康运动','育儿亲子'];
        var legendData = ['下载量'];
        var title = "tendecy";//标题
        var serieData = [];
        var metaDate = [
            [1399, 538, 7132, 289, 409, 209, 2857, 397, 113, 88, 365, 0, 0, 2],
    ...
    function echart_2() {
        ...
        myChart.setOption({
            ...
            yAxis: {
                type: 'category',
                data: [ '通讯社交','影音播放','摄影图像','系统工具','网上购物','金融理财','考试学习','办公商务','生活休闲','新闻阅读','旅游出行','手机美化','健康运动','育儿亲子'],
                axisTick: {
                    show: false
                },
                splitLine: {
            ...
            series: [{
                ...
                type: 'bar',
                data: [2150000000,1050000000,300000000,550000000,610000000,570000000,220000000,330000000,31525000,403000,110000000,86000,46000,552000,]
            },{
                type: 'pie',
                radius: [30, '80%'],
                center: ['75%', '50%'],
